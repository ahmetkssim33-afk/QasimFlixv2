(function(){
  ...
  function improveLoadingText(){
    ...
    let i=0;
    setInterval(()=>{ const el=$('qasim-loading-text'); const modal=$('player-modal'); if(el && modal?.classList.contains('open')) { i=(i+1)%texts.length; el.innerHTML = `${texts[i]}<div class="qf-loading-steps">QasimFlix</div>`; } }, 1600);
  }
