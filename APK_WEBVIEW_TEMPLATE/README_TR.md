...
```java
private static final String HOME_URL = "https://your-sineq-domain.vercel.app/index.html?source=apk";
```
...
## APK site linki
`gradle.properties` içindeki `SINEQ_WEB_URL` değerini kendi Vercel linkinle değiştir.
